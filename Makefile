...
DEV_AGENT_ENV := set PG_DSN=$(DEV_PG_DSN)&& set AGENT_GRPC_ADDR=127.0.0.1:$(DEV_AGENT_GRPC_PORT)&& set DEEPSEEK_API_KEY=$(DEEPSEEK_API_KEY)&& set DEEPSEEK_MODEL=$(DEEPSEEK_MODEL)&&
...
PRO_AGENT_ENV := set PG_DSN=$(PRO_PG_DSN)&& set AGENT_GRPC_ADDR=127.0.0.1:$(PRO_AGENT_GRPC_PORT)&& set DEEPSEEK_API_KEY=$(DEEPSEEK_API_KEY)&& set DEEPSEEK_MODEL=$(DEEPSEEK_MODEL)&&
...
DEV_AGENT_ENV := PG_DSN="$(DEV_PG_DSN)" AGENT_GRPC_ADDR="127.0.0.1:$(DEV_AGENT_GRPC_PORT)" DEEPSEEK_API_KEY="$(DEEPSEEK_API_KEY)" DEEPSEEK_MODEL="$(DEEPSEEK_MODEL)"
...
PRO_AGENT_ENV := PG_DSN="$(PRO_PG_DSN)" AGENT_GRPC_ADDR="127.0.0.1:$(PRO_AGENT_GRPC_PORT)" DEEPSEEK_API_KEY="$(DEEPSEEK_API_KEY)" DEEPSEEK_MODEL="$(DEEPSEEK_MODEL)"
